...
if [ $# -ne 4 ];then
    echo "Usage: $0 <container_name> <container_ip> <add|del> [[<machine_ip>:]<machine_port>:]<container_port>[/<protocol_type>]"
    exit 1
fi
...
echo "[INFO] machine_ip: ${machine_ip}"
echo "[INFO] machine_port: ${machine_port}"
echo "[INFO] container_ip: ${container_ip}"
echo "[INFO] container_port: ${container_port}"
echo "========================================"
